...
class LoginController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    static var sharedController = LoginController()
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Listen", message: "Listen to the hottest songs and albums.", imageName: "page1")
        
        let secondPage = Page(title: "Discover", message: "Don't know what to listen to? Just hit play.", imageName: "page2")
        
        let thirdPage = Page(title: "Everywhere", message: "Bring your music with you to everywhere.", imageName: "page3")
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pc.currentPageIndicatorTintColor = UIColor.themeBaseColor()
    ...
    lazy var skipButton: UIButton = {
        ...
        button.setTitleColor(UIColor.themeBaseColor(), for: .normal)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        LoginController.sharedController = self
