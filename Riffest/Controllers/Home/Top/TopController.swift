...
class TopController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate{
    
    public static var sharedController = TopController()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        TopController.sharedController = self
        self.view.addSubview(collectionView)
        collectionView.register(TopSonCell.self, forCellWithReuseIdentifier: cellId)
...
extension TopController{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! TopSonCell
