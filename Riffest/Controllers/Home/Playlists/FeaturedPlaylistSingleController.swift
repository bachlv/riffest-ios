...
class FeaturedPlaylistSingleController: UITableViewController {
    
    static var sharedController = FeaturedPlaylistSingleController()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        FeaturedPlaylistSingleController.sharedController = self
        setupView()
        onHandleRequestData()
        onHandleGetSong()
    }
...
extension FeaturedPlaylistSingleController {
